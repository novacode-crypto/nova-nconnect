// src/components/TransferModal.tsx  (stub temporal)
export default function TransferModal({ onClose }: { onClose: () => void; session: unknown; onSuccess: (m: string) => void }) {
